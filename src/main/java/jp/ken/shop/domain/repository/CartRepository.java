...
public class CartRepository {
	...
	public ProductEntity findById(String productId) {
		...
		List<ProductEntity> list = jdbcTemplate.query(sql, (rs, rowNum) -> {
	...
	public int deleteByMailAndProductId(String mail, String productId) {
		String sql = """
				    DELETE FROM t_cart
				    WHERE member_mail = ?
				      AND product_id = ?
				""";
		return jdbcTemplate.update(sql, mail, productId);
	}
